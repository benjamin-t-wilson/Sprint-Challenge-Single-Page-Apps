...
> Answer: Client Side Routing requires the client's computer to process and hold all of the data necessary for the website. This results in fewer queries to the server and faster load times between pages for the client.
